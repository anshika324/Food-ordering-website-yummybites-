...
const ChatWidget = () => {
  ...
  useEffect(() => {
    ...
    rec.onresult = (event) => {
      ...
      handleSendText(transcript, { fromVoice: true });
    };
    ...
    try {
     ...
     "https://food-ordering-website-backend-v7w7.onrender.com/api/v1/ai/chat",
      ...
      if (res?.data) {
        ...
        if (action === "redirect_to_summary" && order_id) {
          botMsg.text += " Redirecting you to your order summary page...";
          setTimeout(() => {
...
const styles = {
  ...
  /** ✅ Core Fix — make chat scroll area independent **/
  messageContainer: {
    flex: "1 1 auto",
    minHeight: 0,
    overflowY: "auto",
  ...
  flexWrap: "wrap",
  marginTop: 8,
  maxHeight: "200px",        // 🔥 prevents expansion
  overflowY: "auto",         // 🔥 scrolls if too many dishes
},
...
// 🧩 Scoped fixes: make ChatWidget scroll properly even with global overflow rules
const chatScopedFix = `
  .chat-widget-wrapper * {
